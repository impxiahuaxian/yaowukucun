			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div id="myTabContent" class="tab-content">
						<form action="admin/personal.action" name="myform" method="post" class="form">

							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>用户名</label> ${admin.username}<input type="hidden" name="username" class="form-control" id="username"
							...
							<div>
								<input type="hidden" name="adminid" id="adminid" value="${admin.adminid}" /><input type="hidden"
									...
									value="${admin.addtime}" /><input type="hidden" name="role" id="role" value="${admin.role}" />
