...
<div class="navbar navbar-default" role="navigation">
	<div class="navbar-header">
		<a class=""><span class="navbar-brand"><span class="fa fa-paper-plane"></span>欢迎使用蔬菜批发管理系统</span></a>
	</div>
	<div class="navbar-collapse collapse" style="height: 1px;">
		<ul id="main-menu" class="nav navbar-nav navbar-right">
			<li class="dropdown hidden-xs"><a class="dropdown-toggle" data-toggle="dropdown"> <span
					...
					${sessionScope.adminname }&nbsp;您的身份是&nbsp;${sessionScope.role }
			</a></li>
			...
			<li class="dropdown hidden-xs"><a href="admin/userinfo.action" title=""><span>个人信息</span></a></li>
