		...
		<div class="main-content">
			<table class="table">
				...
				<c:forEach items="${detemineList}" var="detemine">
					<tr align="center">
						<td class="center">${detemine.realname}</td>
						<td class="center">${detemine.vegsname}</td>
						<td class="center">${detemine.num}</td>
						<td class="center">${detemine.addtime}</td>
					</tr>
				</c:forEach>
			</table>
			<ul class="pagination">
				<li>
					<form action="detemine/queryDetemineByCond.action" name="myform" method="post">
						<label>查询条件: <select name="cond" style="width: 100px">
								<option value="adminid">按用户查询</option>
